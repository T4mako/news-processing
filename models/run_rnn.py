...
def train():
    ...
    # 训练结束后手动保存最终模型
    model.save_weights('D:\\code\\text-classification-cnn-rnn-master\\checkpoints\\textrnn\\final_model.weights.h5')  # 保存权重
    model.save('D:\\code\\text-classification-cnn-rnn-master\\checkpoints\\textrnn\\final_model.keras')  # 保存整个模型
...
def test():
    ...
    model = tf.keras.models.load_model(
        'D:\\code\\text-classification-cnn-rnn-master\\checkpoints\\textrnn\\final_model.keras',
        custom_objects={'TextRNN': TextRNN}
    )
